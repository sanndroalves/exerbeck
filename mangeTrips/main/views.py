    ...
    def post(self, request):
        ...
        #checa se a conversa existe
            ...
            try:
                ...
                print(conversationFound.lastCommand)
            except ObjectDoesNotExist:
        ...
        if conversationFound.lastCommand == 'SEARCH_TRIP':
            ...
            if trips.exists():
                for trip in trips:  
                    finalMessage = 'LUGAR:' + trip.title + '\n' + 'PREÇO:' + str(trip.daily)
                pergunta = "Gostaria de reservar?"
                conversationFound.lastCommand = 'RESERVA_PERGUNTA'
                conversationFound.save()
            else:                
