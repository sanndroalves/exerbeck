...
urlpatterns.append( path('conversas/', ConversationView.as_view(), name='conversas'))
urlpatterns.append( path('conversationHistory/', ConversationHistoryView.as_view(), name='conversationHistory'))
